...
Msg-agent is a message broker base on xport used to handle token cross-chain transfer. It receives messages from other chains via "xport" and mint demo token to user account specified by receiver field.
