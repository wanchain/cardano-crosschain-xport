...
PlutusTx.makeLift ''InboundMintCheckInfo
PlutusTx.makeIsDataIndexed ''InboundMintCheckInfo [('InboundMintCheckInfo, 0)]
...
PlutusTx.makeIsDataIndexed ''ParamType [('Version, 0),('Admin, 1),('GPK, 2),('BalanceWorker, 3),('TreasuryCheckVH, 4),('OracleWorker,5),('MintCheckVH, 6),('StkVh, 7),('StakeCheckVH, 8),('NFTRefHolderVH,9),('NFTTreasuryCheckVH, 10),('NFTMintCheckVH, 11),('OutboundHolderVH, 12),('InboundCheckVH, 13)]
...
getGroupInfoParams (GroupInfoParams params) typeId = case typeId of
    ...
    OutboundHolderVH -> params !! 12
    InboundCheckVH -> params !! 13
...
valueLockedBy' ptx h stk =
    let outputs = map snd (scriptOutputsAt' h stk ptx True)
    in mconcat outputs
...
{-# INLINEABLE scredentialToBytes #-}
scredentialToBytes :: Credential -> BuiltinByteString
scredentialToBytes c =  
  case c of
    ScriptCredential (ValidatorHash s) -> s
    _ -> emptyByteString