...
-- tokenHolderScriptShortBs :: KeyParam -> SBS.ShortByteString
-- tokenHolderScriptShortBs = SBS.toShort . LBS.toStrict $ serialise . script

-- tokenHolderScript :: KeyParam -> PlutusScript PlutusScriptV2
-- tokenHolderScript = PlutusScriptSerialised . tokenHolderScriptShortBs

tokenHolderScript :: KeyParam ->  PlutusScript PlutusScriptV2
tokenHolderScript p = PlutusScriptSerialised
  . SBS.toShort
  . LBS.toStrict
  $ serialise 
  (script p)

tokenHolderScriptHash :: KeyParam -> Plutus.ValidatorHash
tokenHolderScriptHash = Scripts.validatorHash . validator

-- tokenHolderScriptHashStr :: PubKeyHash -> BuiltinByteString
-- tokenHolderScriptHashStr = case PlutusTx.fromBuiltinData $ PlutusTx.toBuiltinData . tokenHolderScriptHash of 
--   Just s -> s
--   Nothing -> ""

tokenHolderAddress ::KeyParam -> Ledger.Address
tokenHolderAddress = mkValidatorAddress . validator
